...
This is me just trying to stay sharp. This is just sample code implementing basic data-types and algorithms. 
...
## Added some scala WordSpec for  simple Binary Tree Map

I'd like to add some different [styles of testing](http://www.scalatest.org/user_guide/selecting_a_style) with ScalaTest.
I figure I could do each construct in a different style.      

I used [textik](https://textik.com/) to draw the trees and tried to get all of the removal cases covered for binary trees. 
